...
namespace Infrastructure.Repository.Agendamento
{
    ...
    public class RepositoryAgendamento : IAgendamentoRepository, IDisposable //nome da interface//
    {
        ...
        public void Adcionar(Domain.Entities.Agendamento Objeto)
        {
        ...
        public void Atualizar(Domain.Entities.Agendamento Objeto)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
        ...
        public void Excluir(Domain.Entities.Agendamento Objeto)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
        ...
        public IList<Domain.Entities.Agendamento> Listar()
        {
            using (var banco = new Context(_OptionsBuilder))
            {
                return banco.Set<Domain.Entities.Agendamento>().AsNoTracking().ToList();
            }
        }

        public Domain.Entities.Agendamento ObterPorId(int Id)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
                return banco.Set<Domain.Entities.Agendamento>().Find(Id);
            }
        }
        public void Dispose()
        {
