...
namespace Infrastructure.Repository.Paciente
{
    ...
    public class RepositoryPaciente : IPacienteRepository, IDisposable //nome da interface//
    {
        ...
        public void Adcionar(Domain.Entities.Paciente Objeto)
        {
        ...
        public void Atualizar(Domain.Entities.Paciente Objeto)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
        ...
        public void Excluir(Domain.Entities.Paciente Objeto)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
        ...
        public IList<Domain.Entities.Paciente> Listar()
        {
            using (var banco = new Context(_OptionsBuilder))
            {
                return banco.Set<Domain.Entities.Paciente>().AsNoTracking().ToList();
            }
        }

        public Domain.Entities.Paciente ObterPorId(int Id)
        {
            using (var banco = new Context(_OptionsBuilder))
            {
                return banco.Set<Domain.Entities.Paciente>().Find(Id);
            }
        }
        public void Dispose()
        {
